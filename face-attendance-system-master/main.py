...
class App:
    def __init__(self):
        ...
        self.anti_spoof_model_dir = './Silent-Face-Anti-Spoofing/resources/anti_spoof_models'
    ...
    def login(self):
        label = test(
            ...
            model_dir=self.anti_spoof_model_dir,
            device_id=0
        )
    ...
    def accept_register_new_user(self):
        ...
        # Convert to RGB as face_recognition expects RGB images
